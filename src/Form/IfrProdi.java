...
public class IfrProdi extends javax.swing.JInternalFrame {
    ...
    private void aksiHapus(){
        int jawab = JOptionPane.showConfirmDialog(this, "Anda yakin akan menghapus data ini? ID. User : " +vkd_prodi,
    ...
    private void initComponents() {
        ...
        txtKdProdi.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "Kode Jurusan :"));
        ...
        jLabel5.setText("Form Prodi");

        jLabel7.setText("Form ini digunakan untuk mengolah data program studi");
